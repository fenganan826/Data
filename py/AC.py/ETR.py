...
shap.summary_plot(aggregated_shap, X_val,
...
results_df.to_csv(r'F:\extratrees_test_predictions.csv', index=False, encoding='utf-8-sig')
print("✅ 测试集真实值与预测值已导出至 F:\\extratrees_test_predictions.csv")
